...
export function SettingsForm() {
  ...
  return (
    <Card variant="glass" className="max-w-4xl mx-auto mt-4">
      <CardHeader>
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-6">
          ...
          <Tabs defaultValue="ai" className="w-full">
            <TabsList className="bg-zinc-900/30 border border-zinc-800/30 text-zinc-400 w-full justify-start h-11 p-1">
